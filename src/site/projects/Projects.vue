    ...
    data(){
        return {
            projects: [
                ...
                { title: "Parceria no levantamento de dados para o Relatório Mundial ONU/Mulheres (2020)", images: [ ], description: "Com pesquisadoras na área de direito e medicina, o Instituto Gloria participou do levantamento de dados no Brasil sobre a violência contra mulheres e meninas em momento de pandemia COVID-19 para a geração de relatório mundial da ONU/Mulheres." },
