...
export default {
  ...
  data: () => ({
    ...
    current_option: "",
    heads: [
                { department:"we_page.organogram.ceo.department", head: "we_page.organogram.ceo.head", src:"cristina.jpeg", index:0},
                ...
                { department:"we_page.organogram.legal.department", head: "we_page.organogram.legal.head", src:"cristina_neves.jpeg", index:1},
                { department:"we_page.organogram.tech.department", head: "we_page.organogram.tech.head", src:"gustavo.jpeg", index:2},
                ...
                { department:"we_page.organogram.gov.department", head: "we_page.organogram.gov.head", src:"isabela.jpeg", index:3},
